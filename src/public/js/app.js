...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeBlock", function() { return makeBlock; });
...
function walk(node, context, doNotHoistNode = false) {
    ...
    if (hoistedCount &&
        ...
        Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__["isArray"])(node.codegenNode.children)) {
...
function getConstantTypeOfHelperCall(value, context) {
    if (value.type === 14 /* JS_CALL_EXPRESSION */ &&
        !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__["isString"])(value.callee) &&
...
function createRootCodegen(root, context) {
    ...
    if (children.length === 1) {
        ...
        root.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, root.children, patchFlag + (( true) ? ` /* ${patchFlagText} */` : undefined), undefined, undefined, true, undefined, false /* isComponent */);
    }
    else ;
}
...
function createChildrenCodegenNode(branch, keyIndex, context) {
    ...
    if (needFragmentWrapper) {
        if (children.length === 1 && firstChild.type === 11 /* FOR */) {
            ...
            return createVNodeCall(context, helper(FRAGMENT), createObjectExpression([keyProperty]), children, patchFlag + (( true) ? ` /* ${patchFlagText} */` : undefined), undefined, undefined, true, false, false /* isComponent */, branch.loc);
        }
    }
    else {
...
const transformFor = createStructuralDirectiveTransform('for', (node, dir, context) => {
    ...
    return processFor(node, dir, context, forNode => {
        ...
        forNode.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, renderExp, fragmentFlag +
            (( true) ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__["PatchFlagNames"][fragmentFlag]} */` : undefined), undefined, undefined, true /* isBlock */, !isStableFragment /* disableTracking */, false /* isComponent */, node.loc);
        return () => {
            ...
            if (slotOutlet) {
                ...
                childBlock = createVNodeCall(context, helper(FRAGMENT), keyProperty ? createObjectExpression([keyProperty]) : undefined, node.children, 64 /* STABLE_FRAGMENT */ +
                    (( true)
                        ...
                        : undefined), undefined, undefined, true, undefined, false /* isComponent */);
            }
            else {
...
function buildSlots(node, context, buildSlotFn = buildClientSlotFn) {
    ...
    createSimpleExpression(slotFlag + (( true) ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__["slotFlagsText"][slotFlag]} */` : undefined), false))), loc);
                                    ...
                                    if (arg.type === 15 /* JS_OBJECT_EXPRESSION */) {
                                        return arg.properties.some(({ key }) => {
                                            ...
                                            return (key.content !== 'class' &&
                                                key.content !== 'style' &&
                                                !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__["isOn"])(key.content));
                                        });
                                    }
                                    else {
                                        // dynamic expression
                ...
                if (isText(child) || child.type === 8 /* COMPOUND_EXPRESSION */) {
                    ...
                    if (!context.ssr &&
                        ...
                        callArgs.push(1 /* TEXT */ +
                            (( true) ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__["PatchFlagNames"][1 /* TEXT */]} */` : undefined));
                    }
                    children[i] = {
                        type: 12 /* TEXT_CALL */,
                        content: child,
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "makeBlock", function() { return _vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["makeBlock"]; });
...
const parseInlineCSS = (cssText, loc) => {
    ...
    return Object(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["createSimpleExpression"])(JSON.stringify(normalized), false, loc, 3 /* CAN_STRINGIFY */);
};
...
const transformVText = (dir, node, context) => {
    ...
    return {
        props: [
            Object(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["createObjectProperty"])(Object(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["createSimpleExpression"])(`textContent`, true), exp
                ? Object(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["createCallExpression"])(context.helperString(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["TO_DISPLAY_STRING"]), [exp], loc)
...
const resolveModifiers = (key, modifiers, context, loc) => {
    ...
    for (let i = 0; i < modifiers.length; i++) {
        ...
        if (modifier === 'native' &&
            Object(_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__["checkCompatEnabled"])("COMPILER_V_ON_NATIVE" /* COMPILER_V_ON_NATIVE */, context, loc)) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "computed", function() { return _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__["computed"]; });
        ...
        for (const key in computedOptions) {
            ...
            const set = !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__["isFunction"])(opt) && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__["isFunction"])(opt.set)
                ...
                : ( true)
                    ...
                    : undefined;
            const c = Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__["computed"])({
                get,
                set
            });
            Object.defineProperty(ctx, key, {
...
*/
const isBuiltInDirective = /*#__PURE__*/ Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__["makeMap"])('bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo');
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/index.js?!./resources/js/components/TestVue.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist??ref--26-0!./resources/js/components/TestVue.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************/
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/templateLoader.js?!./node_modules/vue-loader/dist/index.js?!./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--26-0!./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e ***!
  \**************************************************************************************************************************************************************************************************************/
...
function compileToFunction(template, options) {
    ...
    const { code } = Object(_vue_compiler_dom__WEBPACK_IMPORTED_MODULE_1__["compile"])(template, Object(_vue_shared__WEBPACK_IMPORTED_MODULE_2__["extend"])({
        hoistStatic: true,
    ...
    function onError(err, asWarning = false) {
        ...
        const codeFrame = err.loc &&
            Object(_vue_shared__WEBPACK_IMPORTED_MODULE_2__["generateCodeFrame"])(template, err.loc.start.offset, err.loc.end.offset);
...
/* harmony import */ var _components_TestVue_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/TestVue.vue */ "./resources/js/components/TestVue.vue");


const app = Object(vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__["createApp"])({});
app.component('test-vue', _components_TestVue_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
app.mount('#app');

/***/ }),

/***/ "./resources/js/components/TestVue.vue":
/*!*********************************************!*\
  !*** ./resources/js/components/TestVue.vue ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _TestVue_vue_vue_type_template_id_20d7aa0e__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TestVue.vue?vue&type=template&id=20d7aa0e */ "./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e");
/* harmony import */ var _TestVue_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TestVue.vue?vue&type=script&lang=js */ "./resources/js/components/TestVue.vue?vue&type=script&lang=js");
...
const __exports__ = /*#__PURE__*/_var_www_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2___default()(_TestVue_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_TestVue_vue_vue_type_template_id_20d7aa0e__WEBPACK_IMPORTED_MODULE_0__["render"]],['__file',"resources/js/components/TestVue.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/components/TestVue.vue?vue&type=script&lang=js":
/*!*********************************************************************!*\
  !*** ./resources/js/components/TestVue.vue?vue&type=script&lang=js ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_index_js_ref_26_0_TestVue_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib!../../../node_modules/vue-loader/dist??ref--26-0!./TestVue.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/index.js?!./resources/js/components/TestVue.vue?vue&type=script&lang=js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_index_js_ref_26_0_TestVue_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* empty/unused harmony star reexport */ 

/***/ }),

/***/ "./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e":
/*!***************************************************************************!*\
  !*** ./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e ***!
  \***************************************************************************/
/*! exports provided: render */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_templateLoader_js_ref_6_node_modules_vue_loader_dist_index_js_ref_26_0_TestVue_vue_vue_type_template_id_20d7aa0e__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib!../../../node_modules/vue-loader/dist/templateLoader.js??ref--6!../../../node_modules/vue-loader/dist??ref--26-0!./TestVue.vue?vue&type=template&id=20d7aa0e */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/templateLoader.js?!./node_modules/vue-loader/dist/index.js?!./resources/js/components/TestVue.vue?vue&type=template&id=20d7aa0e");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_templateLoader_js_ref_6_node_modules_vue_loader_dist_index_js_ref_26_0_TestVue_vue_vue_type_template_id_20d7aa0e__WEBPACK_IMPORTED_MODULE_0__["render"]; });
